...
# python -m pdb test_ckpts.py --dataset_path filter/avg_vel/Pedestrian/ --ckpts ckpts/Seed_1_Train__0.1_0.3__Val__0.1_0.3__Val_Ratio_0.1_filter_avg_vel_Pedestrian__train_all_weights.pt ckpts/Seed_1_Train__0.5_1.5__Val__0.5_1.5__Val_Ratio_0.1_filter_avg_vel_Pedestrian__train_all_weights.pt ckpts/Seed_1_Train__0.1_0.3__Val__0.1_0.3__Val_Ratio_0.1_filter_avg_vel_Pedestrian__train_all_FT_weights.pt ckpts/Seed_1_Train__0.1_0.3__Val__0.1_0.3__Val_Ratio_0.1_filter_avg_vel_Pedestrian__train_encoder_weights.pt --ckpts_name INDG OODG FT ET --val_files 0.1_0.3.pkl --n_leftouts 100 --viz --depth 2
...
for seed in ${list_seed[@]}; do
    python -m test_ckpts --seed $seed --dataset_name $dataset_name --dataset_path $dataset_path --val_files $val_files --n_leftouts $n_leftouts --ckpts $ckpts --ckpts_name $ckpts_name --depth 1 --limit_by n_viz --n_viz 12 --viz
done 

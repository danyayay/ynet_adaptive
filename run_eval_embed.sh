...
#         list_tuned_ckpt+=("ckpts/Seed_1__Tr_Biker__Val_Biker__ValRatio_0.1__filter_agent_type_deathCircle_0__lora_1__Pos_0_1_2_3_4__TrN_${n_train}__lr_${lr}.pt")
#     done
# done

# for seed in ${list_seed[@]}; do
#     for tuned_ckpt in ${list_tuned_ckpt[@]}; do
#         python test_copy.py --seed $seed --batch_size $batch_size --dataset_path $dataset_path --val_files $val_files --val_ratio $val_ratio --pretrained_ckpt $pretrained_ckpt --tuned_ckpt $tuned_ckpt --n_leftouts $n_leftouts
#     done 
# done 
...
n_leftouts=1500
for seed in ${list_seed[@]}; do
    python test_copy.py --seed $seed --batch_size $batch_size --dataset_path $dataset_path --val_files $val_files --val_ratio $val_ratio --ckpts $ckpts --ckpts_name $ckpts_name --n_leftouts $n_leftouts --add_embedding
done 
# evaluate on biker 
val_files=Biker.pkl
n_leftouts=500
...
# n_leftouts=1500
# for seed in ${list_seed[@]}; do
#     python test.py --seed $seed --batch_size $batch_size --dataset_path $dataset_path --val_files $val_files --val_ratio $val_ratio --ckpts $ckpts --ckpts_name $ckpts_name --n_leftouts $n_leftouts
# done 
# # evaluate on biker 
# val_files=Biker.pkl
# n_leftouts=500

...
def main(args):
    ...
    if args.generate_csv:
        ...
        _, _, list_metrics_pretrained = pretrained_model.test(df_test, IMAGE_PATH, False, False, False) 
        if args.replace_tuned:
        ...
        if args.depth == -1:
            ...
            for tuned, tuned_name in zip(args.tuned, args.tuned_name):
                ...
                set_random_seeds(args.seed)
                _, _, list_metrics_tuned = tuned_model.test(df_test, IMAGE_PATH, False, False, False)         

...
def augment_data(data, image_path='data/SDD/train', images={}, image_file='reference.png', seg_mask=False, use_raw_data=False):
    '''
    ...
    :return:
    '''
    assert image_file == 'reference.png'
    ks = [1, 2, 3]
...
def create_images_dict(unique_scene, image_path, image_file='reference.png', use_raw_data=False):
    images = {}
    assert image_file == 'reference.png'
...
def create_dataset_by_agent_type(
    ...
    print('Statistics:\n', df_gb.count()['metaId'] / 35)
    print('# total:', (df_gb.count()['metaId'] / 35).sum())

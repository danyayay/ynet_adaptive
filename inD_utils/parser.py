...
def get_data_args(parser):
    ...
    parser.add_argument('--ckpt_path', default='ckpts_inD')
...
def get_train_args(parser):
    ...
    parser.add_argument("--config_filename", default='inD_longterm_train.yaml', type=str)
...
def get_eval_args(parser):
    parser.add_argument("--config_filename", default='inD_longterm_eval.yaml', type=str)
    return parser
